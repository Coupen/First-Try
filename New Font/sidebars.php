    ...
    ?>
        <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        <li id="menu-home" ><a href="index.html"><i class="fa fa-user-o"></i><span>User</span></a></li>
		        <li id="menu-comunicacao" ><a href="#"><i class="fa fa-codepen"></i><span>Coupan</span></a>
		        </li>
		        <li><a href="#"><i class="fa fa-cogs"></i><span>Companies</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
		            <li><a href="grids.html">Brands</a></li>
		            <li><a href="portlet.html">Sub-Brands</a></li>		            
		          </ul>
		        </li>
		        ...
		        <li><a href="charts.html"><i class="fa fa-comments"></i><span>Comments</span></a></li>
